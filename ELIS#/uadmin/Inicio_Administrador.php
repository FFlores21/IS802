  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-card-checklist" viewBox="0 0 16 16">
    ...
    <header  style="background-color: rgba(24, 154, 198, 0.99); height: 100px;">
      ...
      <a class="boton" style="padding-left: 5%; color:white; font-size:larger;" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
        <svg class="bi me-2" width="30" height="30"><use xlink:href="#solicitud"/></svg>Solicitudes
      </a>
      ...
      <a href="Stats.html" style="padding-left: 3%; color: white;font-size: larger;">Statistics</a>
