...
<!--=============================================================Formulario========================================================================-->
        ...
        <div class="formulario">
            <form action="Guardar_Junta.php" method="post" enctype ="multipart/form-data">
                ...
                <button type="submit" name="register" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop2">Inscribir</button>
            </form>
...
<div class="modal fade" id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content  modal_solicitud">
      ...
      <p style="text-align: center">Junta Registrada.</p>
