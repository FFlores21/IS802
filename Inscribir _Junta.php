...
<!--=============================================================Cuerpo========================================================================-->
      ...
      <div class="contenido_login" style="background-image: url(img/back.jpg);">
        ...
        <div>
          ...
          <h3 class="titulos" style="text-align:center;color:#333 ;margin:0% auto; padding: 3% auto;"> JUNTA</h3>
...
<!--=============================================================Formulario========================================================================-->
        ...
        <div class="formulario">
            <form action="Guardar_Junta.php" method="POST" enctype ="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Imagen/Logo</label>
                    <input type="file" REQUIRED name ="Imagen" class="form-control" id="exampleInputPassword1">
                </div>
